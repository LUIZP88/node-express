...
// Persistência
mongoose.connect('mongodb+srv://luizpaulo:lu15p4ul0@cluster0-usoip.mongodb.net/test?retryWrites=true&w=majority', { useNewUrlParser: true, useCreateIndex: true, useUnifiedTopology: true });
